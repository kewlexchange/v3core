...
func (_Flash *FlashTransactor) BiswapCall(opts *bind.TransactOpts, sender common.Address, amount0 *big.Int, amount1 *big.Int, data []byte) (*types.Transaction, error) {
	return _Flash.contract.Transact(opts, "BiswapCall", sender, amount0, amount1, data)
}

// BiswapCall is a paid mutator transaction binding the contract method 0x5b3bc4fe.
//
// Solidity: function BiswapCall(address sender, uint256 amount0, uint256 amount1, bytes data) returns()
func (_Flash *FlashSession) BiswapCall(sender common.Address, amount0 *big.Int, amount1 *big.Int, data []byte) (*types.Transaction, error) {
	return _Flash.Contract.BiswapCall(&_Flash.TransactOpts, sender, amount0, amount1, data)
}

// BiswapCall is a paid mutator transaction binding the contract method 0x5b3bc4fe.
//
// Solidity: function BiswapCall(address sender, uint256 amount0, uint256 amount1, bytes data) returns()
func (_Flash *FlashTransactorSession) BiswapCall(sender common.Address, amount0 *big.Int, amount1 *big.Int, data []byte) (*types.Transaction, error) {
	return _Flash.Contract.BiswapCall(&_Flash.TransactOpts, sender, amount0, amount1, data)
}
...
// HandleSwapEx is a paid mutator transaction binding the contract method 0x44c6d2b4.
//
// Solidity: function handleSwapEx((uint256,uint256,uint256,uint256,address,address,address[])[] flashParams) payable returns()
func (_Flash *FlashTransactor) HandleSwapEx(opts *bind.TransactOpts, flashParams []SwapFlashParams) (*types.Transaction, error) {
	return _Flash.contract.Transact(opts, "handleSwapEx", flashParams)
}

// HandleSwapEx is a paid mutator transaction binding the contract method 0x44c6d2b4.
//
// Solidity: function handleSwapEx((uint256,uint256,uint256,uint256,address,address,address[])[] flashParams) payable returns()
func (_Flash *FlashSession) HandleSwapEx(flashParams []SwapFlashParams) (*types.Transaction, error) {
	return _Flash.Contract.HandleSwapEx(&_Flash.TransactOpts, flashParams)
}

// HandleSwapEx is a paid mutator transaction binding the contract method 0x44c6d2b4.
//
// Solidity: function handleSwapEx((uint256,uint256,uint256,uint256,address,address,address[])[] flashParams) payable returns()
func (_Flash *FlashTransactorSession) HandleSwapEx(flashParams []SwapFlashParams) (*types.Transaction, error) {
	return _Flash.Contract.HandleSwapEx(&_Flash.TransactOpts, flashParams)
}
...
func (_Flash *FlashTransactor) JetswapCall(opts *bind.TransactOpts, sender common.Address, amount0 *big.Int, amount1 *big.Int, data []byte) (*types.Transaction, error) {
	return _Flash.contract.Transact(opts, "jetswapCall", sender, amount0, amount1, data)
}

// JetswapCall is a paid mutator transaction binding the contract method 0x3fc01685.
//
// Solidity: function jetswapCall(address sender, uint256 amount0, uint256 amount1, bytes data) returns()
func (_Flash *FlashSession) JetswapCall(sender common.Address, amount0 *big.Int, amount1 *big.Int, data []byte) (*types.Transaction, error) {
	return _Flash.Contract.JetswapCall(&_Flash.TransactOpts, sender, amount0, amount1, data)
}

// JetswapCall is a paid mutator transaction binding the contract method 0x3fc01685.
//
// Solidity: function jetswapCall(address sender, uint256 amount0, uint256 amount1, bytes data) returns()
func (_Flash *FlashTransactorSession) JetswapCall(sender common.Address, amount0 *big.Int, amount1 *big.Int, data []byte) (*types.Transaction, error) {
	return _Flash.Contract.JetswapCall(&_Flash.TransactOpts, sender, amount0, amount1, data)
}
...
func (_Flash *FlashTransactor) PancakeCall(opts *bind.TransactOpts, sender common.Address, amount0 *big.Int, amount1 *big.Int, data []byte) (*types.Transaction, error) {
	return _Flash.contract.Transact(opts, "pancakeCall", sender, amount0, amount1, data)
}

// PancakeCall is a paid mutator transaction binding the contract method 0x84800812.
//
// Solidity: function pancakeCall(address sender, uint256 amount0, uint256 amount1, bytes data) returns()
func (_Flash *FlashSession) PancakeCall(sender common.Address, amount0 *big.Int, amount1 *big.Int, data []byte) (*types.Transaction, error) {
	return _Flash.Contract.PancakeCall(&_Flash.TransactOpts, sender, amount0, amount1, data)
}

// PancakeCall is a paid mutator transaction binding the contract method 0x84800812.
//
// Solidity: function pancakeCall(address sender, uint256 amount0, uint256 amount1, bytes data) returns()
func (_Flash *FlashTransactorSession) PancakeCall(sender common.Address, amount0 *big.Int, amount1 *big.Int, data []byte) (*types.Transaction, error) {
	return _Flash.Contract.PancakeCall(&_Flash.TransactOpts, sender, amount0, amount1, data)
}
